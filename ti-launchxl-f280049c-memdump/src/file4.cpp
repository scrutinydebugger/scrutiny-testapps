...
void file4SetValues()
{
    ...
    file4classB.array_of_A2[2][0].A2enum = File4NamespaceA1::YYY;
    ...
    file4classB_array[0].array_of_A2[2][0].A2enum = File4NamespaceA1::XXX;
    ...
    file4classB_array[1].array_of_A2[2][0].A2enum = File4NamespaceA1::XXX;
    ...
    file4classB_array[2].array_of_A2[2][0].A2enum = File4NamespaceA1::YYY;
