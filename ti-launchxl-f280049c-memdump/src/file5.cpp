...
namespace File5NamespaceB
{
    ...
    int64_t *file5i64_ptr =  NULL ;
    int32_t *file5i32_ptr =  NULL ;
    int16_t *file5i16_ptr =  NULL ;

    uint64_t *file5u64_ptr =  NULL ;
    uint32_t *file5u32_ptr =  NULL ;
    uint16_t *file5u16_ptr =  NULL ;

    File5NamespaceA::File5StructA *file5_structA_ptr =  NULL ;
    File5NamespaceA::File5StructB *file5_structB_ptr =  NULL ;
    File5NamespaceA::File5StructB *file5_structB_array_ptr =  NULL ;
